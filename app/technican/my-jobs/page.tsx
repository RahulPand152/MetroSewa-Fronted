            ...
            <Card className="rounded-2xl border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                <CardHeader className="border-b border-slate-100 dark:border-slate-800 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <Badge className="bg-primary hover:bg-primary-active text-white text-xs">{jobs.length} jobs</Badge>
                    </div>
                </CardHeader>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-3 flex-wrap mb-1">
                                                {job.user?.avatar || job.customer?.avatar ? (
                                                    ...
                                                    <div className="h-8 w-8 bg-primary/10 text-primary text-xs font-bold flex items-center justify-center rounded-full shrink-0">
                                                        {customerName.charAt(0).toUpperCase()}
                                                    </div>
                                                )}
                                                <p className="text-base font-semibold text-slate-800 dark:text-slate-200 group-hover:text-primary transition-colors">{job.service?.name}</p>
