...
const navItems = [
    { label: "Dashboard", href: "/user", icon: LayoutDashboard, tooltip: "Dashboard" },
    { label: "My Bookings", href: "/user/my-bookings", icon: CalendarCheck, tooltip: "My Bookings" },
    { label: "Profile", href: "/user/profile", icon: User, tooltip: "Profile" },
    { label: "Help & Support", href: "/user/help-support", icon: HelpCircle, tooltip: "Help & Support" },
];
                ...
                >
                    <div className="relative flex-shrink-0">
                        <Avatar className="h-9 w-9 border-2 border-sky-200 dark:border-sky-800">
                            <AvatarImage
                                src="https://ui-avatars.com/api/?name=John+Doe&background=0ea5e9&color=fff&size=80"
                                alt="John Doe"
                            />
                            <AvatarFallback className="bg-sky-500 text-white text-sm font-bold">JD</AvatarFallback>
                        </Avatar>
